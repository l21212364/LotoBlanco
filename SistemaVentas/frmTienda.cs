    ...
    public partial class frmTienda : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            if (oListaTienda.Count > 0)
            {
                ...
                tablaTienda.Columns.Add("RFC", typeof(string));
                ...
                {
                    tablaTienda.Rows.Add(row.IdTienda, row.Nombre, row.RFC, row.Direccion, row.Telefono, row.Activo == true ? "Activo":"No Activo", row.Activo);
                }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            if (dgvTienda.SelectedRows.Count > 0)
            {
                ...
                Tienda oTienda = new Tienda() {
                    ...
                    RFC = dgvTienda.Rows[index].Cells["RFC"].Value.ToString(),
